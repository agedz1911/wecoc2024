<div class="bg-slate-50">
    ...
    <div class="hero min-h-screen bg-slate-50 bg-[url('images/hero_bg_6.png')]">
        <div class="hero-overlay bg-opacity-20"></div>
        <div class="hero-content flex-col justify-start lg:flex-row">

            <div class="">
                <h1 class="text-5xl text-white font-bold">36<sup>th</sup> WECOC <br>Weekend Course on Cardiology
                </h1>
                <div class="py-6">
                    <p class="italic text-white font-semibold text-lg mb-5">" Augmenting Intelligence in Cardiology and
                        Vascular
                        Medicine "
                    </p>
                    ...
                    <a href="/registration"> <button class="btn text-primary-500 border-none mt-8">Register
                            Now</button></a>
                    <a href="/congress-information"> <button class="btn btn-outline text-white hover:bg-primary-500 hover:border-none">Read
                            More</button></a>
                </div>
            </div>
            <div class="hidden lg:flex">
                <img src="images/kosong.png" class="max-w-sm  " alt="">
            </div>
        </div>
    </div>
    {{-- End Hero --}}
    <div class="lg:px-14 px-3 flex justify-center">
        <div class="card w-full lg:w-1/2 bg-doctor bg-primary-50 text-white -top-20 md:-top-0 lg:-top-20 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105">
    ...
    {{-- Start About --}}
    <div class="pb-24 px-4 mb-5 md:mt-10 container mx-auto items-center">
        <div class="flex flex-col gap-8 justify-between lg:flex-row">
            ...
            <div class="w-full px-0 lg:pl-10 lg:py-5">
                ...
                <p class="text-slate-400 font-semibold italic text-lg lg:mt-8 mt-4">" Augmenting Intelligence in
                    Cardiology and
                    Vascular Medicine "
                </p>
                ...
                <div class="lg:mt-10 mt-5 flex items-center gap-4">
                    <a href="/registration" class="btn w-1/3 bg-primary-800 hover:bg-primary-600 border-none text-white ">Register
                        Now</a>
                    <a href="/congress-information" class="btn w-1/3 btn-outline-primary ">Read More</a>
                </div>
        ...
        <div class="card card-side bg-base-100 shadow-xl">
            <div class="flex flex-col md:flex-row justify-between items-start">
                ...
                <div class="card-body">
                    ...
                    <p class="text-justify text-slate-600">The Weekend Course in Cardiology (WECOC), hosted by the
                        Department of Cardiology and Vascular Medicine at the Faculty of Medicine, Universitas
                        Indonesia,
                        has been a cornerstone of scientific excellence since its inception in 1989. This annual event,
                        which continues to thrive, serves as a vital platform for medical professionals to stay abreast
                        of
                        cutting-edge advancements in cardiology.</p>
                    <p class="text-justify text-slate-600">Save the Date!.</p>
                    <p class="text-justify text-slate-600">The 36<sup>th</sup> Weekend Course in Cardiology is
                        scheduled for October 25<sup>th</sup> - 26<sup>th</sup> , 2024. Mark your calendars and join us
                        for
                        an enriching experience that promises to elevate cardiovascular care.</p>
                    <div class="card-actions justify-end">
                        <a href="congress-information#welcome-message" class="float-end mt-10 btn bg-primary-800 text-slate-100 border-none hover:bg-primary-600">Read
                            More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="border rounded-lg shadow-md px-5 pb-10">
                <div class="flex flex-col items-center relative">
                    <div class="flex shadow-md items-center gap-3 py-3 px-5 flex-row absolute rounded-full -top-9 bg-primary-500">
                        ...
                        <h1 class="text-white font-semibold">Call for Abstract</h1>
                    </div>
                    <div class="text-center flex flex-col mt-16 mb-5">
    ...
    {{-- CIJ --}}
    <div class="bg-cij pt-20 pb-24 px-4 mb-5 md:mt-10">
        <div class="container mx-auto items-center">
            <div class="flex flex-col gap-8 justify-between lg:flex-row">

                <div class="w-full px-0 lg:pl-10 lg:py-5 order-last lg:order-first">
                    <p class="text-slate-100 font-semibold italic text-2xl lg:mt-8 mt-4">Register your team and join
                        the battle of</p>
                    <h1 class="text-4xl lg:text-6xl text-center lg:text-left mt-5 text-white mb-5 font-bold uppercase">
                        Cardiology in jeopardy</h1>

                    <a href="/cardiology-in-jeopardy" class="btn btn-lg w-1/3 btn-ghost float-end text-white"><i class="fa-solid fa-circle-info"></i> Read More</a>
                ...
                <div class="w-full justify-center md:pt-10 order-first md:order-last">
                    <div class="mockup-window border bg-white">
                        <div class="flex justify-center px-4 py-5 bg-slate-100">
                            <video class=" rounded-lg" controls muted autoplay loop>
                                <source src="images/video/cij-promo.mp4" type="video/mp4" />
                                Your browser does not support the video tag.
                            </video>
                        </div>
                    </div>
    ...
    {{-- Start Counter --}}
    <div class="bg-scroll bg-primary-900 bg-counter relative lg:px-20 px-5 py-52">
        <div class="flex flex-col md:flex-row flex-wrap gap-2 text-white justify-between">
    ...
    <div class="bg-local pt-40 pb-52 lg:px-20 px-5 bg-blog">
        <div class="w-full mb-10">
            <iframe class="w-full rounded-lg shadow-md" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.2780618688607!2d106.82436907587592!3d-6.227022660986392!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3fad694635d%3A0x7955433b5d801fd6!2sJW%20Marriott%20Jakarta%2C%20Kuningan%2C%20East%20Kuningan%2C%20Setiabudi%2C%20South%20Jakarta%20City%2C%20Jakarta%2012950!5e0!3m2!1sen!2sid!4v1719798590611!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
