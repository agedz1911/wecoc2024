<div class="bg-slate-50">
            ...
            <div class="">
                ...
                <div class="py-6">
                    ...
                    <a href="/registration"> <button class="btn text-primary-500 border-none mt-8">Register
                            Now</button></a>
                    <a href="/congress-information"> <button
                            class="btn btn-outline text-white hover:bg-primary-500 hover:border-none">Read
                            More</button></a>
                </div>
            </div>
    ...
    <div class="lg:px-14 px-3 flex justify-center">
        <div
            class="card w-full lg:w-1/2 bg-doctor bg-primary-50 text-white -top-20 md:-top-0 lg:-top-20 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105">
        ...
        <div class="flex flex-col gap-8 justify-between lg:flex-row">
            ...
            <div class="w-full px-0 lg:pl-10 lg:py-5">
                ...
                <div class="lg:mt-10 mt-5 flex items-center gap-4">
                    <a href="/registration"
                        class="btn w-1/3 bg-primary-800 hover:bg-primary-600 border-none text-white ">Register
                        Now</a>
    ...
    <div class="pb-24 px-4 mb-10 container mx-auto items-center mt-10">
        <div class="card card-side bg-base-100 shadow-xl">
            <div class="flex flex-col md:flex-row justify-between items-start">
                <figure>
                    <img class="bg-[#32bea6] rounded-lg ring ring-primary ring-offset-base-100 ring-offset-4"
                        src="images/chairman-new.png">
            ...
            <div class="flex flex-col gap-8 justify-between lg:flex-row">
                ...
                <div class="w-full px-0 lg:pl-10 lg:py-5 order-last lg:order-first">
                    <p class="text-slate-100 font-semibold italic text-2xl lg:mt-8 mt-4">Register your team and join
                        the battle of</p>
                    <h1
                        class="text-4xl lg:text-6xl text-center lg:text-left mt-5 text-white mb-5 font-bold uppercase">
                        Cardiology in jeopardy</h1>

                    <a href="/cardiology-in-jeopardy" class="btn btn-lg w-1/3 btn-ghost float-end text-white"><i
                            class="fa-solid fa-circle-info"></i> Read More</a>
    ...
    <div class="bg-local pt-40 pb-52 lg:px-20 px-5 bg-blog">
        <div class="w-full mb-10">
            <iframe class="w-full rounded-lg shadow-md"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.2780618688607!2d106.82436907587592!3d-6.227022660986392!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3fad694635d%3A0x7955433b5d801fd6!2sJW%20Marriott%20Jakarta%2C%20Kuningan%2C%20East%20Kuningan%2C%20Setiabudi%2C%20South%20Jakarta%20City%2C%20Jakarta%2012950!5e0!3m2!1sen!2sid!4v1719798590611!5m2!1sen!2sid"
