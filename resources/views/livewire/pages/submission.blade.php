<div class="bg-slate-50">
    <div class="bg-local pt-20 pb-52 lg:px-20 px-5 bg-blog" id="guideline-abstract">
        <div class="flex-col flex lg:flex-row justify-between gap-3 mb-10">
            ...
            <div class="order-first lg:order-last">
                <div class="flex shadow-md items-center gap-3 py-1 px-5 flex-row  rounded-full bg-primary-500">
                    <div class="avatar">
                        <div class="w-10 bg-white rounded-full">
                            <i class="fa-solid fa-bell text-primary-500 text-2xl py-1 px-2"></i>
                        </div>
                    </div>
        ...
        <div class="bg-white border border-gray-200 divide-y divide-gray-200 rounded-lg">
            <details class="p-6 group" open>
                ...
                <ul class="mt-4 leading-relaxed text-slate-500 list-disc px-10">
                    ...
                    <li><span class="text-primary-600 font-semibold">Summary of Important Dates:</span>
                        <ul class="list-item mx-3">
                            <li>a. Open Submission: 1 August 2024</li>
                            <li>b. Close Submission: 31 August 2024</li>
                            <li>c. Review and Grading Score: 1-27 September 2024</li>
            ...
            <details class="p-6 group">
                ...
                <p class="mt-4 font-semibold leading-relaxed text-primary-600">
                    Technical Details
                </p>
