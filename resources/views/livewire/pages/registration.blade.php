        ...
        <div x-data="{ openTab: 1 }" class="p-2">
            <div class="w-full mx-auto">
                <div class="mb-4 flex space-x-4 p-2 bg-white rounded-lg shadow-md">
                    <button x-on:click="openTab = 1" :class="{ 'bg-primary-600 text-white': openTab === 1 }" class="flex-1 py-2 px-4 rounded-md focus:outline-none focus:shadow-outline-primary transition-all duration-300">25 October 2024</button>
                    <button x-on:click="openTab = 2" :class="{ 'bg-primary-600 text-white': openTab === 2 }" class="flex-1 py-2 px-4 rounded-md focus:outline-none focus:shadow-outline-primary transition-all duration-300">26 October 2024</button>
                </div>
                ...
                <div x-show="openTab === 1" class="transition-all duration-300 bg-white p-4 rounded-lg shadow-md border-l-4 border-primary-600">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 ">
                        <div class="card bg-price ">
                            <div class="card-body w-full">
                                <h2 class="card-title text-primary-500">Cardiac Critical Care <div class="badge">WS 1</div></h2>
                        ...
                        <div class="card bg-price ">
                            <div class="card-body w-full">
                                <div>
                                    <h2 class="card-title text-primary-500">Invasive cardiology: Mastering Coronary Physiology Assesment: Beyond Anatomy</h2>
                        ...
                        <div class="card bg-price ">
                            <div class="card-body w-full">
                                <div>
                                    <h2 class="card-title text-primary-500">Mitral Regurgitation: From Anatomy to Treatment, Focus on Echocardiography</h2>
                ...
                <div x-show="openTab === 2" class="transition-all duration-300 bg-white p-4 rounded-lg shadow-md border-l-4 border-primary-600">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 ">
                        ...
                        <div class="card bg-price ">
                            <div class="card-body w-full">
                                <div>
                                    <h2 class="card-title text-primary-500">Imaging in Congenital Heart Disease (Focus in ToF)</h2>
                        ...
                        <div class="card bg-price ">
                            <div class="card-body w-full">
                                <div>
                                    <h2 class="card-title text-primary-500">An Overview of Cardiopulmonary Excercise Testing in Clinical Practice</h2>
